...
const HERO_SRC = "/images/bce.png";

export function BceProjectView() {
  const images = [
    { src: HERO_SRC, alt: "Best Car Events platform" },
    ...
    <main className="min-h-screen w-full bg-black text-white">
      ...
      <section className="relative z-10 mx-auto max-w-3xl px-6 pb-[max(3rem,env(safe-area-inset-bottom))] pt-16 md:pt-24">
        ...
        <p className="mt-6 text-lg leading-relaxed text-white/85 md:text-xl">
          BestCarEvents.com is a comprehensive search platform designed to help users
          discover automotive events globally. Built with a focus on performance and
          usability, it aggregates event data into a structured interface, allowing users
          to filter and explore events efficiently. The platform emphasizes clean UI/UX and
          scalable architecture to handle diverse datasets and user interactions.
        </p>
        <div className="mt-10">
          <Button
            asChild
