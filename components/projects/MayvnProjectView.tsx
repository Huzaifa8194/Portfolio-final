...
const HERO_SRC = "/images/mayvn.png";

export function MayvnProjectView() {
  const images = [
    { src: HERO_SRC, alt: "Mayvn app" },
    ...
    <main className="min-h-screen w-full bg-black text-white">
      ...
      <section className="relative z-10 mx-auto max-w-3xl px-6 pb-[max(3rem,env(safe-area-inset-bottom))] pt-16 md:pt-24">
        ...
        <p className="mt-6 text-lg leading-relaxed text-white/85 md:text-xl">
          Mayvn is a mobile-first productivity and lifestyle application that combines task
          management with personal well-being tracking into a single intuitive ecosystem.
          Designed under a fast-paced, problem-solving environment, it focuses on simplifying
          daily organization while incorporating elements of mental clarity and user
          engagement. The platform prioritizes clean design, smooth interactions, and
          practical usability, making it a holistic tool for users seeking both productivity
          and balance in their daily routines.
        </p>
        <div className="mt-10">
          <Button
            asChild
