...
const HERO_SRC = "/images/oracle.png";

export function OracleGrupoProjectView() {
  const images = [
    { src: HERO_SRC, alt: "Oracle Grupo crypto mining platform" },
  ...
  return (
    <main className="min-h-screen w-full bg-black text-white">
      <div className="relative flex min-h-[40vh] flex-col items-center justify-center px-6 pt-[max(1rem,env(safe-area-inset-top))] pb-8 md:min-h-[45vh]">
        ...
        <p className="mt-2 text-center text-sm text-white/45 md:text-base">
      ...
      <section className="relative z-10 mx-auto max-w-3xl px-6 pb-[max(3rem,env(safe-area-inset-bottom))] pt-16 md:pt-24">
        ...
        <p className="mt-6 text-lg leading-relaxed text-white/85 md:text-xl">
          Oracle Grupo is a crypto mining rental platform designed to provide users with
          real-time access to mining infrastructure and performance analytics. It enables
          users to rent mining rigs while monitoring output and efficiency through a
          dynamic dashboard. The system focuses on transparency, performance tracking, and
          user accessibility, offering a streamlined experience for individuals entering
        ...
        <div className="mt-10">
          ...
          >
            <a
              href="https://oraclegroupo.vercel.app"
              target="_blank"
