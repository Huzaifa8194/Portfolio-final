...
const HERO_SRC = "/images/rivera.png";

export function RiveraProjectView() {
  const images = [
    { src: HERO_SRC, alt: "Rivera Travels platform" },
    ...
    <main className="min-h-screen w-full bg-black text-white">
      ...
      <section className="relative z-10 mx-auto max-w-3xl px-6 pb-[max(3rem,env(safe-area-inset-bottom))] pt-16 md:pt-24">
        ...
        <p className="mt-6 text-lg leading-relaxed text-white/85 md:text-xl">
          Rivera Travels is a modern travel platform designed to simplify trip planning and
          booking through a clean, user-centric digital experience. Built with a strong focus
          on UI/UX and performance, the platform streamlines the discovery of destinations,
          travel packages, and booking options into a seamless flow. It emphasizes intuitive
          navigation, responsive design, and scalable architecture, enabling users to explore
          and plan their journeys efficiently while ensuring reliability and speed across
          devices.
        </p>
        <div className="mt-10">
          <Button
          ...
          >
            <a
              href="https://rivera-delta.vercel.app"
              target="_blank"
